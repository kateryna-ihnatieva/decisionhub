...
def process_hurwitz_file(
    file, num_alternatives, num_conditions, upload_folder="uploads"
):
    """
    Process uploaded file for Hurwitz method
    ...
    try:
        ...
        # Extract data
        result = extract_hurwitz_data(data, num_alternatives, num_conditions)
...
def extract_hurwitz_data(data, num_alternatives, num_conditions):
    """
    Extract Hurwitz data from parsed file data
    ...
    # Process the table
    table_data = data[table_boundaries[0][0] : table_boundaries[0][1]]
    result = extract_hurwitz_matrix(table_data, num_alternatives, num_conditions)
...
def extract_hurwitz_matrix(data, num_alternatives, num_conditions):
    """
    Extract Hurwitz matrix from table data
    ...
    if len(data) < 2:
        return {
            ...
            "conditions_names": [],
            "cost_matrix": [],
            "error": "Insufficient data for Hurwitz matrix",
        }
