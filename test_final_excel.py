#!/usr/bin/env python3
"""
Test final Excel export without consistency sheet
"""
...
def test_final_excel_export():
    ...
    analysis_data = {
        "method_id": 123,
        "task_description": "Фінальний тест Excel експорту",
    ...
    try:
        ...
        # Check final sheet structure (no consistency sheet)
        expected_sheets = [
            "Загальна інформація",
            "Матриця критеріїв",
            "Матриця_Якість",
        ...
        if sheet_names == expected_sheets:
            print("✅ Final sheet structure is correct!")
        else:
            print("❌ Final sheet structure is incorrect!")
